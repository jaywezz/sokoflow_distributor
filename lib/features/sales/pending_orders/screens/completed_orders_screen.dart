...
class CompletedOrders extends ConsumerStatefulWidget {
  static const routeName = "completed_orders_screen";
  const CompletedOrders({Key? key}) : super(key: key);

  @override
  ConsumerState<CompletedOrders> createState() => _CompletedOrdersState();
}
                        ...
                        child: ListView.builder(
                            ...
                            itemBuilder: (BuildContext ctx, int index) {
                              ...
                              return Container(
                                  ...
                                  child: OrderCard(color: Styles.pendingColor,)
                              );
                            }),
                      ));
                },
